...
import { UserIcon, NextIcon, SearchIcon } from '../Icons';
        ...
        <div className="desktop-header">
          <div className="header-primary-menu">
            ...
            <ul className="header-menu-container">
              ...
              <li>
                <NavLink exact={true} to="/categories" activeClassName="active">
                  Movies
                </NavLink>
              </li>
              <li>
                <NavLink exact={true} to="/shows" activeClassName="active">
                  Shows
                </NavLink>
              </li>
              {/* <li>
                <NavLink exact={true} to="/livetv" activeClassName="active">
                  Live TV
                </NavLink>
              </li> */}
              <li>
                <NavLink exact={true} to="/free" activeClassName="active">
                  Free
                </NavLink>
              </li>
              {/* <li>
            ...
            <nav className="mobo-nav">
              ...
              <div className="mobo-nav-bottom-bar">
                ...
                <div className="mobo-app-store-container">
                  <a href="#!">
                    {/* <img src={playstorePng} alt="" srcSet="" /> */}
                  </a>
                  <a href="#!">
                    {/* <img src={appstorePng} alt="" srcSet="" /> */}
                  </a>
                </div>
              </div>
            </nav>
