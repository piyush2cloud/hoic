exports.id = "components-CategoryCarousel";
exports.ids = ["components-CategoryCarousel"];
exports.modules = {

/***/ "./src/client/components/CategoryCarousel/index.js":
/*!*********************************************************!*\
  !*** ./src/client/components/CategoryCarousel/index.js ***!
  \*********************************************************/
/*! namespace exports */
...
/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.css */ "./src/client/components/CategoryCarousel/styles.css");
...
/* harmony import */ var _assets_images_play_video_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../assets/images/play-video.svg */ "./src/client/assets/images/play-video.svg");
...
function index(_ref) {
  ...
  var handleIndicatorClick = function handleIndicatorClick(e) {
    e.persist();
    var activeElement = document.querySelector('.category-carousel-indicator-list-item.active');
    var currentElement = e.currentTarget;
    if (currentElement.classList.contains('active')) return;
    activeElement.classList.remove('active');
    currentElement.classList.add('active');
    var indicatorNewActiveElementScrollPosition = currentElement.offsetLeft;
    currentElement.parentElement.scrollTo({
      top: 0,
      left: indicatorNewActiveElementScrollPosition - 100,
      behavior: 'smooth'
    });
    var activeElementIndex = currentElement.dataset.slideIndex;
    var activeCarouselElement = document.querySelector('.category-carousel-image-container.active');
    var unactiveElement = document.querySelector('.category-carousel-image-container.unactive');
    var carouselElements = document.querySelectorAll('.category-carousel-image-container');
    ...
    var carouselElementToBeActive = carouselElements[parseInt(activeElementIndex, 10)];
    carouselElementToBeActive.classList.add('active');

    if (parseInt(activeElement.dataset.slideIndex, 10) < parseInt(activeElementIndex, 10)) {
      carouselElementToBeActive.style.animationName = 'category-carousel-slide-in-right-to-left';
      activeCarouselElement.style.animationName = 'category-carousel-slide-out-right-to-left';
    } else {
      carouselElementToBeActive.style.animationName = 'category-carousel-slide-in-left-to-right';
      activeCarouselElement.style.animationName = 'category-carousel-slide-out-left-to-right';
    }
  };

  var handleNext = function handleNext() {
    var activeElement = document.querySelector('.category-carousel-image-container.active');
    var nextElement = activeElement.nextSibling;
    var prevElement = activeElement.previousSibling;

    if (!nextElement.classList.contains('category-carousel-image-container')) {
      nextElement = document.querySelector('.category-carousel-image-container');
    }

    if (!prevElement.classList.contains('category-carousel-image-container')) {
      prevElement = document.querySelector('.category-carousel-image-container:nth-last-of-type(2)');
    }
    ...
    nextElement.style.animationName = 'category-carousel-slide-in-right-to-left';
    activeElement.style.animationName = 'category-carousel-slide-out-right-to-left';
    var indicatorActiveElement = document.querySelector('.category-carousel-indicator-list-item.active');
    var indicatorAllElement = document.querySelectorAll('.category-carousel-indicator-list-item');
    indicatorActiveElement.classList.remove('active');
    var nextElementIndex = nextElement.dataset.slideIndex;
    var indicatorNewActiveElement = indicatorAllElement[parseInt(nextElementIndex, 10)];
    indicatorNewActiveElement.classList.add('active');
    var indicatorNewActiveElementScrollPosition = indicatorNewActiveElement.offsetLeft;
  ...
  var handlePrev = function handlePrev() {
    ...
    if (!nextElement.classList.contains('category-carousel-image-container')) {
      nextElement = nextElement = document.querySelector('.category-carousel-image-container');
    }
    ...
    activeElement.classList.add('unactive');
    activeElement.classList.remove('active');
    prevElement.style.animationName = 'category-carousel-slide-in-left-to-right';
    activeElement.style.animationName = 'category-carousel-slide-out-left-to-right';
    nextElement && nextElement.classList.remove('unactive');
    var indicatorActiveElement = document.querySelector('.category-carousel-indicator-list-item.active');
    var indicatorAllElement = document.querySelectorAll('.category-carousel-indicator-list-item');
    indicatorActiveElement.classList.remove('active');
    var prevElementIndex = prevElement.dataset.slideIndex;
    var indicatorNewActiveElement = indicatorAllElement[parseInt(prevElementIndex, 10)];
    indicatorNewActiveElement.classList.add('active');
    var indicatorNewActiveElementScrollPosition = indicatorNewActiveElement.offsetLeft;
    indicatorNewActiveElement.parentElement.scrollTo({
      top: 0,
  ...
  var handleCategoryClick = function handleCategoryClick(e, category) {
    e.persist();
    var curretnElement = e.currentTarget;
    if (curretnElement.classList.contains('active')) return;
    var activeCategoryElement = document.querySelector('.category-carousel-category-list-item.active');
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "category-carousel-parent"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "category-carousel-slide-container"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "category-carousel-category-bar"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "category-carousel-category-list"
  }, categoryData.map(function (category, index) {
    return category.title && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      className: "category-carousel-category-list-item ".concat(index == 0 ? 'active' : ''),
      onClick: function onClick(e) {
        handleCategoryClick(e, category);
      }
    }, category.title);
  }))), indicatorData.map(function (carouselData, index) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-image-container ".concat(index == 0 ? 'active' : ''),
      style: {
        backgroundImage: "url(".concat(carouselData.gist.imageGist._32x9, "), linear-gradient(#212121, #212121)")
      },
      key: "".concat(index, "-category-carousel-image-container"),
      "data-slide-index": index
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-image-gradient"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-title"
    }, carouselData.gist.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-feature-container"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-age-restriction"
    }, "13+"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
      className: "category-carousel-feature-list"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      className: "category-carousel-video-duration"
    }, "34 mins"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      className: "category-carousel-video-year"
    }, "2020"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      className: "category-carousel-video-category"
    }, "Drama"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-action-button-container"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "categoory-carousel-play-button"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-play-icon"
      ...
      className: "category-carousel-play-text"
    }, "Play Now")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "category-carousel-info-button-container"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-info-icon"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Icons__WEBPACK_IMPORTED_MODULE_2__.InfoIcon, null))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "category-carousel-plus-button-container"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: "category-carousel-plus-icon"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Icons__WEBPACK_IMPORTED_MODULE_2__.PlusIcon, null))))));
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "category-carousel-controls"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "category-carousel-prev-icon",
    onClick: handlePrev
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Icons__WEBPACK_IMPORTED_MODULE_2__.NextIcon, null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "category-carousel-next-icon",
    onClick: handleNext
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Icons__WEBPACK_IMPORTED_MODULE_2__.NextIcon, null)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "category-carousel-indicator-container"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    className: "category-carousel-indicator-list"
  }, indicatorData.map(function (indicator, index) {
    return indicator.gist && indicator.gist.imageGist && indicator.gist.imageGist._16x9 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      className: "category-carousel-indicator-list-item ".concat(index == 0 ? 'active' : ''),
      key: "".concat(index, "-category-carousel"),
      ...
      src: _assets_images_play_video_svg__WEBPACK_IMPORTED_MODULE_3__.default,
      alt: "",
...
/***/ "./src/client/assets/images/play-video.svg":
/*!*************************************************!*\
  !*** ./src/client/assets/images/play-video.svg ***!
  \*************************************************/
/*! namespace exports */
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/play-video.svg");

/***/ }),

/***/ "./src/client/components/CategoryCarousel/styles.css":
/*!***********************************************************!*\
  !*** ./src/client/components/CategoryCarousel/styles.css ***!
  \***********************************************************/
...
;
//# sourceMappingURL=components-CategoryCarousel.server.js.map